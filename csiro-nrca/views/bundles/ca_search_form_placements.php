...
?>
<div class="component component-bundle component-bundle-search-form-placements" id="<?php print $vs_id_prefix; ?>">
    <?php print caEditorBundleMetadataDictionary($this->request, $vs_id_prefix, $this->getVar('settings') ?: array()); ?>
    <div class="row">
        <div class="col-md-12">
            <div class="alert alert-info">
                <span class="glyphicon glyphicon-info-sign"></span>
                <?php print _t("Drag your selection from column to column to edit the contents of the search form."); ?>
            </div>
        </div>
    </div>
    <div class="row bundle-list-container">
        <div class="col-md-6">
            <label><?php print _t("Available search form elements"); ?></label>
            <div id="bundleDisplayEditorAvailableList"></div>
        </div>
        <div class="col-md-6">
            <label><?php print _t("Search form elements"); ?></label>
