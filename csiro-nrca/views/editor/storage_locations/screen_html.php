...
$this->setVar('delete_url', caNavUrl($this->request, 'editor/storage_locations', 'StorageLocationEditor', 'Delete/'.$this->request->getActionExtra(), array('location_id' => $vn_location_id)));
$this->setVar('cancel_url', caNavUrl($this->request, 'editor/storage_locations', 'StorageLocationEditor', 'Edit/'.$this->request->getActionExtra(), ($vn_location_id ? array('location_id' => $vn_location_id) : array('type_id' => $t_location->getTypeID()))));
?>
