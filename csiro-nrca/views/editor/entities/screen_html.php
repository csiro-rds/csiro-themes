...
$this->setVar('delete_url', caNavUrl($this->request, 'editor/entities', 'EntityEditor', 'Delete/'.$this->request->getActionExtra(), array('entity_id' => $vn_entity_id)));
$this->setVar('cancel_url', caNavUrl($this->request, 'editor/entities', 'EntityEditor', 'Edit/'.$this->request->getActionExtra(), ($vn_entity_id ? array('entity_id' => $vn_entity_id) : array('type_id' => $t_entity->getTypeID()))));
?>
