...
$this->setVar('delete_url', caNavUrl($this->request, 'editor/occurrences', 'OccurrenceEditor', 'Delete/'.$this->request->getActionExtra(), array('occurrence_id' => $vn_occurrence_id)));
$this->setVar('cancel_url', caNavUrl($this->request, 'editor/occurrences', 'OccurrenceEditor', 'Edit/'.$this->request->getActionExtra(), ($vn_occurrence_id ? array('occurrence_id' => $vn_occurrence_id) : array('type_id' => $t_occurrence->getTypeID()))));
?>
