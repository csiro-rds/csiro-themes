...
$this->setVar('delete_url', caNavUrl($this->request, 'editor/movements', 'MovementEditor', 'Delete/'.$this->request->getActionExtra(), array('movement_id' => $vn_movement_id)));
$this->setVar('cancel_url', caNavUrl($this->request, 'editor/movements', 'MovementEditor', 'Edit/'.$this->request->getActionExtra(), ($vn_movement_id ? array('movement_id' => $vn_movement_id) : array('type_id' => $t_movement->getTypeID()))));
?>
